...
Source0  : https://files.pythonhosted.org/packages/31/b1/a43e3bd872ded4deea4f8efc7aff1703fca8c5455d0c06e20506a06a44ff/pdfminer.six-20231228.tar.gz
...
%prep
%setup -q -n pdfminer.six-20231228
cd %{_builddir}/pdfminer.six-20231228
pushd ..
cp -a pdfminer.six-20231228 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707130147
