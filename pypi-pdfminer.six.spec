...
Source0  : https://files.pythonhosted.org/packages/a8/27/1a99ce4cfce829bb91040f82a53f33b33fec4e070d2b9c1b45f6796cd8dc/pdfminer_six-20250416.tar.gz
...
%prep
%setup -q -n pdfminer_six-20250416
cd %{_builddir}/pdfminer_six-20250416
pushd ..
cp -a pdfminer_six-20250416 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744813008
