...
Source0  : https://files.pythonhosted.org/packages/e3/37/63cb918ffa21412dd5d54e32e190e69bfc340f3d6aa072ad740bec9386bb/pdfminer.six-20240706.tar.gz
...
%prep
%setup -q -n pdfminer.six-20240706
cd %{_builddir}/pdfminer.six-20240706
pushd ..
cp -a pdfminer.six-20240706 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730263673
